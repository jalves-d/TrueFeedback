...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      ...
      ,[tr_imp]
      ,[cb_imp]
  FROM [TrueFeedback].[dbo].[master_agent_tbl], [TrueFeedback].[dbo].[master_regdia_tbl]
  WHERE TrueFeedback.dbo.master_agent_tbl.tp = TrueFeedback.dbo.master_regdia_tbl.tp_agente"></asp:SqlDataSource>
                            <div class="col">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    ...
                                                                    /<asp:Label ID="Label6" runat="server" Font-Bold="True" Text='<%# Eval("year") %>'></asp:Label>
                                                                     | TMO :
                                                                    <asp:Label ID="Label7" runat="server" Font-Bold="True" Text='<%# Eval("tmo") %>'></asp:Label>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    Números de Gestões :
                                                                    <asp:Label ID="Label10" runat="server" Font-Bold="True" Text='<%# Eval("num_gest") %>'></asp:Label>
                                                                     | Transferências para Vendas :
                                                                    <asp:Label ID="Label11" runat="server" Font-Bold="True" Text='<%# Eval("tr_vend") %>'></asp:Label>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    Transferências Improcedentes :
                                                                    <asp:Label ID="Label8" runat="server" Font-Bold="True" Text='<%# Eval("tr_imp") %>'></asp:Label>
                                                                    &nbsp;| Callbacks Improcedentes :
                                                                    <asp:Label ID="Label9" runat="server" Font-Bold="True" Text='<%# Eval("cb_imp") %>'></asp:Label>
                                                                    &nbsp;
                                                                </div>
                                                            </div>
                                                        </div>
